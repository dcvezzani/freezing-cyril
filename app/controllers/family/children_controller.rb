class Family::ChildrenController < AjaxableController

  # # GET /family/children
  # # GET /family/children.json
  # def index
  #   @family_children = Family::Child.where{new_and_returning_member_progress_id == my{params[:new_and_returning_member_progress_id]}}
